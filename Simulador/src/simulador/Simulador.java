    ...
    public static void main(String[] args) throws JSimInvalidParametersException, JSimMethodNotSupportedException {
        try
        {
            ...
            try (FileWriter fw = new FileWriter(arquivo, true)) {
                ...
                queue1 = new FilaNavios("Fila Entrada de Navios no Porto", simulation, null);
                //queue2 = new FilaNavios("Fila 2", simulation, null);

                berco1 = new Berco("Berco 1", simulation, mu1, p1, queue1, null);
                //berco2 = new Berco("Berco 2", simulation, mu2, p2, queue2, queue1);
                
                generator1 = new GeradorNavios("Gerador 1", simulation, lambda1, queue1, containersDescarregar);
                ...
                simulation.message("Fila 1: Tamanho médio da fila = " + queue1.getLw() + ", Tempo médio de espera na fila dos navios que já deixaram o porto = " + queue1.getTw() + ", Tempo médio de espera na fila dos navios = " + queue1.getTwForAllLinks());
                bw.write("\r\nFila 1: Tamanho médio da fila = " + queue1.getLw() + ", \r\nTempo médio de espera na fila dos navios que já deixaram o porto = " + queue1.getTw() + ", \r\nTempo médio de espera na fila dos navios = " + queue1.getTwForAllLinks() + "\r\n");
